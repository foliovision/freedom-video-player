...
freedomplayer(function(api, root) {
  ...
  api.shareUrl = function(directEmbed) {
    ...
    var title = encodeURIComponent(api.video.title || (common.find('title')[0] || {}).innerHTML || 'Freedom Player video')
    ...
    return "\\u" + ("0000" + chr.charCodeAt(0).toString(16)).substr(-4)
      ...
      , baseUrl = directEmbed ? 'https://freedomplayer.com/e/' : 'https://freedomplayer.com/s/';
