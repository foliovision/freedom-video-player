...
/**
 * Adds or removes a class from an element based on a flag
 * @param {HTMLElement} el  - The target element
 * @param {string}      key - The attribute name. If it's class, then it will be set to className.
 * @param {boolean}     val - If false, it removes the attribute. Otherwise, it sets the attribute to the value.
 */
...
common.offset = function(el) {
  ...
  if (el.offsetWidth / el.offsetHeight > el.clientWidth / el.clientHeight) { // https://github.com/foliovision/freedom-video-player/issues/757
    ret = {
      left: ret.left * 100,
      right: ret.right * 100,
      top: ret.top * 100,
