...
if (support.touch || isIeMobile) {
   ...
   freedomplayer(function(player, root) {
      ...
      // TODO: Improve to only add arrows once it starts playing
      if ( ! common.hasClass( 'no-controlbar', root ) ) {
         var forward = common.createElement('div', {className: 'fp-forward' }, ICON_FORWARD ),
      ...
      // Only do this once as it's slowing things down
      ...
      bean.on(root, 'touchend click', function(e) {
         ...
         var do_not_show_overlay = common.hasClass(root, 'is-mouseover')
            ...
            // Splash end image with play button
            common.hasClass( e.target, 'wpfp_custom_background' ) ||
            common.hasClass( e.target.parentNode, 'wpfp_custom_background' )
         ;
         ...
         if( video ) {
            ...
            player.bind("progress.dur", function() {
               ...
               if (duration !== 1) {
                  ...
                  common.find(".fp-duration", root)[0].innerHTML = format( player.get_video_duration() );
