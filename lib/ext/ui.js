...
var LOADING_ROUNDED_OUTLINE = fs.readFileSync(__dirname + '/ui/svg/loading-rounded-outline.svg', 'utf-8')
  , LOADING_ROUNDED_FILL = fs.readFileSync(__dirname + '/ui/svg/loading-rounded-fill.svg', 'utf-8')
  , LOADING_SHARP_FILL = fs.readFileSync(__dirname + '/ui/svg/loading-sharp-fill.svg', 'utf-8')
  , LOADING_SHARP_OUTLINE = fs.readFileSync(__dirname + '/ui/svg/loading-sharp-outline.svg', 'utf-8');
