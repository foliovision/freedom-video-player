...
freedomplayer(function(api, root) {
   ...
   var ui = common.createElement('div', {className: 'fp-ui', style: 'display: none'}, '\
         ...
         <div class="fp-controls">\
            <a class="fp-icon fp-playbtn" tabindex="0" role="button" aria-label="Play Video"></a>\
            <span class="fp-elapsed">00:00</span>\
            <div class="fp-timeline fp-bar">\
               <span class="fp-timestamp"></span>\
               <div class="fp-progress fp-color" aria-orientation="horizontal" tabindex="0" role="slider" aria-label="video timeline" aria-valuemin="0" aria-valuemax="0" aria-valuetext="0 seconds" aria-valuenow="0"></div>\
            </div>\
            <span class="fp-duration"></span>\
            <span class="fp-remaining"></span>\
            <div class="fp-volume">\
               <a class="fp-icon fp-volumebtn" tabindex="0"></a>\
               <div class="fp-volumebar fp-bar-slider" aria-orientation="horizontal" tabindex="0" role="slider" aria-label="video volume" aria-valuemin="0" aria-valuemax="0" aria-valuetext="0" aria-valuenow="0">\
                 <em></em><em></em><em></em><em></em><em></em><em></em><em></em>\
               </div>\
            </div>\
            <a class="fp-fullscreen fp-icon" tabindex="0">\
  ...
  var waiting = find('waiting'),
      ...
      if (is_over) {
         ...
         var reg = function(e) {
            ...
            if ( ! support.touch && 'number' === typeof( e.clientY ) ) {
               ...
               common.toggleClass(root, 'is-mouseover-top', y < ( 0.33 * ui.clientHeight ) && ! api.accessibility_focus );
               ...
               if ( common.hasClass(root, 'is-fullscreen') && y < ( 0.05 * ui.clientHeight ) && e.clientX > ( ui.clientWidth * 0.95 ) ) {
                  ...
                  common.toggleClass(root, 'is-mouseover-bottom', y > ( 0.8 * ui.clientHeight ) || timelineTooltip_hover || api.accessibility_focus );
   ...
   api.on("ready", function(ev, api, video) {
      ...
      // Set .fp-progress aria-valuemax to duration
      common.attr( progress, 'aria-valuemax', duration );
   ...
   // progress
      ...
      // Set .fp-progress aria-valuenow to time
      common.attr( progress, 'aria-valuenow', Math.round( time, 1 ) );
      common.attr( progress, 'aria-valuetext', format( time ) + ' seconds' );
