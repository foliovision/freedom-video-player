...
freedomplayer(function(api, root) {
  ...
  api.bind('ready', function() {
    ...
    // Wait for the first resume event as Chromecast JS might not be ready yet when the video initializes. This is important for video preload.
    api.one( 'resume', function() {
      session = window.cast && cast.framework.CastContext.getInstance().getCurrentSession();
