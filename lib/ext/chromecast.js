...
freedomplayer(function(api, root) {
  ...
  function createUIElements() {
    ...
    // There are two fullscreen buttons - in header and on controlbar. Insert Airplay before the one which is visible
    common.find('.fp-fullscreen').forEach(function(el) {
