   ...
   var ui = common.createElement('div', {className: 'fp-ui', style: 'display: none'}, '\
         ...
         <div class="fp-controls">\
            ...
            <a class="fp-fullscreen fp-icon">\
               <svg xmlns="http://www.w3.org/2000/svg" class="fp-fullscreen-enter" viewBox="1 1 34 24"><path d="M1 9V1h12M1 17v8h12M35 9V1H23M35 17v8H23"></path></svg>\
               <svg xmlns="http://www.w3.org/2000/svg" class="fp-fullscreen-exit" viewBox="0 0 35 26"><path d="M23 26v-8h12M12 26v-8H0M12 0v8H0M23 0v8h12"></path></svg>\
            </a>\
