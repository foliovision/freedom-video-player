  ...
  var waiting = find('waiting'),
         ...
         var reg = function(e) {
            ...
            if ( 'number' === typeof( e.clientY ) ) {
               ...
               if ( common.hasClass(root, 'is-fullscreen') && y < ( 0.05 * ui.clientHeight ) && e.clientX > ( ui.clientWidth * 0.95 ) ) {
                  console.log( 'y',y, ( 1/8 ) * ui.clientHeight);
                  ...
                  common.toggleClass(root, 'is-mouseover-bottom', y > ( 0.8 * ui.clientHeight ) );
   ...
   function hover_worker(flag) {
     if (flag) {
      ...
      // Do not hide the hover controls if the mouse is over the bottom or top of the player
