   ...
   var ui = common.createElement('div', {className: 'fp-ui', style: 'display: none'}, '\
         ...
         <div class="fp-controls">\
            ...
            <a class="fp-fullscreen fp-icon">\
               <svg class="fp-fullscreen-enter" xmlns="http://www.w3.org/2000/svg" viewBox="-2 -2 40 30" fill="none" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M1 9V1h12" /><path d="M1 9V1h12" transform="matrix(1 0 0 -1 0 26)" /><path d="M1 9V1h12" transform="matrix(-1 0 0 1 36 0)" /><path d="M1 9V1h12" transform="rotate(180 18 13)" /></svg>\
               <svg class="fp-fullscreen-exit" xmlns="http://www.w3.org/2000/svg" viewBox="-1 -2 40 30" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M1 9V1h12" transform="translate(22 17)" /><path d="M1 9V1h12" transform="matrix(-1 0 0 1 13 17)" /><path d="M1 9V1h12" transform="rotate(180 6.5 4.5)" /><path d="M1 9V1h12" transform="matrix(1 0 0 -1 22 9)" /></svg>\
            </a>\
